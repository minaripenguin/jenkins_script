...
with_gapps="no"
use_brunch="bacon"
folder="/home2/${user}/arcane" # Folder Name
rom_name="Arcane"*.zip # Zip name
...
if [ -f $ROM ]; then
        ...
        mkdir -p /home2/downloads/${user}/${device_codename}
        cp $ROM /home2/downloads/${user}/${device_codename}
